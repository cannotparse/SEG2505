package com.seg2505f.expertenligne_rep_betterversion;
...
public class ListeCategoriesActivity extends SwarmActivity {
    ...
    Map<String, List<String>> sousDomaines; // sous-domainvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvve
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ExpandableListAdapter expListAdapter = new ExpandableListAdapter(this, groupList, sousDomaines);
