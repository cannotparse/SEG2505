...
public class ClientFrame extends Frame
{
  ...
  public ClientFrame(String u, String h, int p)
  {
    super("OCSF Client");

    client = new SimpleClient(u, h, p, liste);
  ...
  public static void main(String[] arg)
  {
    ClientFrame sf;
    if (arg.length==0)
     sf = new ClientFrame("Guest", "localhost",12345);
    if (arg.length==1)
     sf = new ClientFrame("Guest", "localhost",Integer.parseInt(arg[0]));
    if (arg.length==2)
     sf = new ClientFrame("Guest", arg[0],Integer.parseInt(arg[1]));
    if (arg.length==3)
     sf = new ClientFrame(arg[0], arg[1],Integer.parseInt(arg[2]));
  }
}
